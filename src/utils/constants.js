...
export const API_OPTIONS = {
  ...
  headers: {
    ...
    Authorization:
      "Bearer " + process.env.REACT_APP_TMDB_TOEKN,
  },
};

export const IMG_CDN_URL = "https://image.tmdb.org/t/p/w780";

export const TOGATHER_AI_KEY = process.env.REACT_APP_TOGATHER_AI_KEY;
...
export const NOW_PLAYING_MOVIES = [
  ...
  },
  {
      ...
      "overview": "When her mother sends her on a quest to complete a teenage bucket list, a young woman uncovers family secrets, finds romance — and rediscovers herself.",
      "popularity": 171.316,
...
export const GET_MOVIE_DETAILS = [
    {
        ...
        "id": "675b55f2175de8c282ba8bce"
    },
    {
        "iso_639_1": "en",
        "iso_3166_1": "US",
        "name": "Redband Online Trailer",
        "key": "RtjzAWUb9mA",
        "site": "YouTube",
        "size": 1080,
        "type": "Trailer",
        "official": true,
        "published_at": "2024-12-12T17:11:52.000Z",
        "id": "675b55d0784f588e80982c85"
    },
    {
        "iso_639_1": "en",
        "iso_3166_1": "US",
        ...
        "type": "Trailer",
        "official": true,
        "published_at": "2024-12-12T14:59:50.000Z",
        "id": "675c0d85673096e5668e511c"
    }
];
...
export const UPCOMING_MOVIES = {
    ...
    "results": [
        ...
        },
        {
            ...
            "overview": "Paddington travels to Peru to visit his beloved Aunt Lucy, who now resides at the Home for Retired Bears. With the Brown Family in tow, a thrilling adventure ensues when a mystery plunges them into an unexpected journey through the Amazon rainforest and up to the mountain peaks of Peru.",
            "popularity": 33.9074,
        ...
        },
        {
            ...
            "overview": "When the ongoing rivalry between farmers Michael and Jack suddenly escalates, it triggers a chain of events that take increasingly violent and devastating turns, leaving both families permanently altered.",
            "popularity": 30.6887,
